...
La version 1.0.0 propose deux modes d'exécution : FullPython, le mode standard sans base de données, et DB legacy pour les organisations qui souhaitent conserver les données dans PostgreSQL/PostGIS.
